...
namespace Cashflow.Web.Service.Clases
{
    ...
    {
        private string clave = "CaJeRoSeMPReSaRiaLeS*2021";
        ...
        public string Decodificar(string cadena)
        {
            ...
            TripleDESCryptoServiceProvider tripledes = new TripleDESCryptoServiceProvider { Key = llave, Mode = CipherMode.ECB, Padding = PaddingMode.PKCS7 };
